  ...
  <section>
    <v-container>
      <v-row>
        ...
        <!-- <v-vol v-if="$vuetify.breakpoint.smAndDown" class="mx-auto pt-16">
          <GoogleRate
            :caption1="rcaption1"
            :caption2="rcaption2"
            :icon="ricon"
...
export default {
  ...
  props: {
    ...
    rcaption1: { type: String, required: true },
    rcaption2: { type: String, required: true },
    fcaption1: { type: String, required: true },
    fcaption2: { type: String, required: true },
